...
export const CompetitionCreateWithoutCategoriesInputSchema: z.ZodType<Prisma.CompetitionCreateWithoutCategoriesInput> = z.object({
  name: z.string(),
...
export default CompetitionCreateWithoutCategoriesInputSchema;
