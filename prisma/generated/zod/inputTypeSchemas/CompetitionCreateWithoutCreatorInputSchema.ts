...
export const CompetitionCreateWithoutCreatorInputSchema: z.ZodType<Prisma.CompetitionCreateWithoutCreatorInput> = z.object({
  name: z.string(),
...
export default CompetitionCreateWithoutCreatorInputSchema;
