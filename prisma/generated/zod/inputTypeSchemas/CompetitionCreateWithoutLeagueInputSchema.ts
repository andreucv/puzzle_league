...
export const CompetitionCreateWithoutLeagueInputSchema: z.ZodType<Prisma.CompetitionCreateWithoutLeagueInput> = z.object({
  name: z.string(),
...
export default CompetitionCreateWithoutLeagueInputSchema;
