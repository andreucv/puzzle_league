...
export const CompetitionCreateWithoutRequestsInputSchema: z.ZodType<Prisma.CompetitionCreateWithoutRequestsInput> = z.object({
  name: z.string(),
...
export default CompetitionCreateWithoutRequestsInputSchema;
