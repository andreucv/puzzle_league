...
export const CompetitionCreateWithoutRoleAssignmentsInputSchema: z.ZodType<Prisma.CompetitionCreateWithoutRoleAssignmentsInput> = z.object({
  name: z.string(),
...
export default CompetitionCreateWithoutRoleAssignmentsInputSchema;
