...
export const CompetitionUncheckedCreateInputSchema: z.ZodType<Prisma.CompetitionUncheckedCreateInput> = z.object({
...
export default CompetitionUncheckedCreateInputSchema;
