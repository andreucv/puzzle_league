...
import { CategoryUpdateManyWithoutPuzzlesNestedInputSchema } from './CategoryUpdateManyWithoutPuzzlesNestedInputSchema';
...
export const PuzzleUpdateInputSchema: z.ZodType<Prisma.PuzzleUpdateInput> = z.object({
  ...
  categories: z.lazy(() => CategoryUpdateManyWithoutPuzzlesNestedInputSchema).optional()
}).strict();

export default PuzzleUpdateInputSchema;
