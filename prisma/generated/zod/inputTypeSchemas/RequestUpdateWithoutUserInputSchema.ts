...
import { CompetitionUpdateOneWithoutRequestsNestedInputSchema } from './CompetitionUpdateOneWithoutRequestsNestedInputSchema';
...
export const RequestUpdateWithoutUserInputSchema: z.ZodType<Prisma.RequestUpdateWithoutUserInput> = z.object({
  ...
  competition: z.lazy(() => CompetitionUpdateOneWithoutRequestsNestedInputSchema).optional()
}).strict();

export default RequestUpdateWithoutUserInputSchema;
