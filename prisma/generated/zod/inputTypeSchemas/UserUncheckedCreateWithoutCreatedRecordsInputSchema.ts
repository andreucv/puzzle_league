...
export const UserUncheckedCreateWithoutCreatedRecordsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutCreatedRecordsInput> = z.object({
  id: z.string(),
  name: z.string(),
  email: z.string(),
...
export default UserUncheckedCreateWithoutCreatedRecordsInputSchema;
