...
export const UserUncheckedCreateWithoutLeaguePointsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutLeaguePointsInput> = z.object({
  id: z.string(),
  name: z.string(),
  email: z.string(),
...
export default UserUncheckedCreateWithoutLeaguePointsInputSchema;
