...
export const UserUncheckedCreateWithoutRoleAssignmentsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutRoleAssignmentsInput> = z.object({
  id: z.string(),
  name: z.string(),
  email: z.string(),
...
export default UserUncheckedCreateWithoutRoleAssignmentsInputSchema;
