...
export const CompetitionUpdateArgsSchema: z.ZodType<Prisma.CompetitionUpdateArgs> = z.object({
  select: CompetitionSelectSchema.optional(),
  include: z.lazy(() => CompetitionIncludeSchema).optional(),
  data: z.union([ CompetitionUpdateInputSchema,CompetitionUncheckedUpdateInputSchema ]),
  where: CompetitionWhereUniqueInputSchema,
}).strict() ;

export default CompetitionUpdateArgsSchema;
