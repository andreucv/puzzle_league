...
import { CompetitionUpdateInputSchema } from '../inputTypeSchemas/CompetitionUpdateInputSchema'
import { CompetitionUncheckedUpdateInputSchema } from '../inputTypeSchemas/CompetitionUncheckedUpdateInputSchema'
...
export const CompetitionUpsertArgsSchema: z.ZodType<Prisma.CompetitionUpsertArgs> = z.object({
  select: CompetitionSelectSchema.optional(),
  include: z.lazy(() => CompetitionIncludeSchema).optional(),
  where: CompetitionWhereUniqueInputSchema,
  create: z.union([ CompetitionCreateInputSchema,CompetitionUncheckedCreateInputSchema ]),
  update: z.union([ CompetitionUpdateInputSchema,CompetitionUncheckedUpdateInputSchema ]),
}).strict() ;

export default CompetitionUpsertArgsSchema;
