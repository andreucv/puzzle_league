...
export const RoleAssignmentCreateArgsSchema: z.ZodType<Prisma.RoleAssignmentCreateArgs> = z.object({
  select: RoleAssignmentSelectSchema.optional(),
  include: z.lazy(() => RoleAssignmentIncludeSchema).optional(),
  data: z.union([ RoleAssignmentCreateInputSchema,RoleAssignmentUncheckedCreateInputSchema ]),
}).strict() ;

export default RoleAssignmentCreateArgsSchema;
