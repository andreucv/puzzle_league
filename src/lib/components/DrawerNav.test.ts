...
const mockUser = { id: '1', name: 'Test User', email: 'test@example.com', image: null };
...
describe('DrawerNav - Anonymous user', () => {
	...
	it('shows home and competitions links', () => {
		render(DrawerNav, { props: { user: null, roleAssignments: [] } });
...
describe('DrawerNav - Participant user', () => {
	...
	it('shows home and competitions links', () => {
		render(DrawerNav, { props: { user: mockUser, roleAssignments: [] } });
...
describe('DrawerNav - Organizer user', () => {
	...
	const organizerRoles = [{ role: 'ORGANIZER' }];

	it('shows create competition link', () => {
		render(DrawerNav, { props: { user: mockUser, roleAssignments: organizerRoles } });
...
describe('DrawerNav - Admin user', () => {
	...
	it('shows review permissions requests link', () => {
		render(DrawerNav, { props: { user: mockUser, roleAssignments: adminRoles } });
