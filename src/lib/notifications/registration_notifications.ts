...
/**
 * Send registration-confirmed notifications based on the record composition:
 *
 ...
 *    2.2 Record has only external participants → notify creator (mentioning non-platform names).
 *
