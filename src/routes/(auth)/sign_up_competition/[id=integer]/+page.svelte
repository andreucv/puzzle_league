...
<div class="container mx-auto max-w-4xl">
    ...
    <form method="post" action="?/signup" class="space-y-6">
        ...
        <div class="space-y-4">
            <h2 class="text-2xl font-semibold mb-4">Choose Your Categories</h2>
            <p class="text-gray-600 mb-4">You can participate in multiple categories</p>
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                />
                                <label for="category_{category.id}" class="text-xl font-semibold cursor-pointer">
                                    {category.name}
                                </label>
                            </div>
                            ...
                            <div class="flex gap-4 text-sm text-gray-500">
                                ...
                                {/if}
                                <span>👥 {category.type === 'INDIVIDUAL' ? 'Individual' : `Team of ${category.maxPartySize || 2}`}</span>
                            </div>
                        </div>
                    </div>
