<script lang="ts">
    ...
    const typeIcons: Record<string, string> = {
        REGISTRATION_CREATED: 'mdi:account-plus-outline',
        ...
        EXTERNAL_PARTICIPANT_CLAIMED: 'mdi:account-check-outline',
    ...
    const typeColors: Record<string, string> = {
        REGISTRATION_CREATED: 'text-primary-500',
        ...
        EXTERNAL_PARTICIPANT_CLAIMED: 'text-primary-500',
